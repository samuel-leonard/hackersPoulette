...
<body>
  ...
  <header>
    <nav id='myNav' class="navbar navbar-expand-lg navbar-dark navbar-fixed-top bg-light">
      <a class="navbar-brand ml-5" href="#">
        <img src="./assets/img/hackers-poulette-logo - Copie.png" width="10vh" height="10vh" alt="logo">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample05">
        <ul class="navbar-nav mr-auto ml-5">
          <li class="nav-item active">
            <a class="nav-link h3 mr-5" href="#">Accueil <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link  h3 mr-5" href="#produits">Produits</a>
          </li>
          <li class="nav-item">
            <a class="nav-link h3 mr-5" href="#services">Services</a>
          </li>
          <li class="nav-item">
            <a class="nav-link h3" href="#contact">Contact</a>
          </li>
        </ul>
        <button type="button" data-toggle="modal" data-target="#modalLoginForm" class="btn btn-info login">Se
          connecter</button>
        <button type="button" data-toggle="modal" data-target="#modalRegisterForm" class="btn btn-info register">Créer
          un compte</button>
      </div>
    </nav>
    <div class="jumbotron">
        ...
        <div class="carousel-inner">
          <div id="slide-one" class="carousel-item active">
            ...
            <div class="carousel-caption d-md-block">
              <h5 class="justify-content-center"><span>Lorem ipsum dolor sit, amet consectetur adipisicing elit. </span>
              </h5>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur amet doloremque non, dolorum, sed
                quia, maiores deserunt quibusdam deleniti qui quasi aspernatur. Accusamus quia quasi quidem dolores ea
                suscipit dicta!</p>
              <button type="button" class="btn btn-danger">Decouvrir les offres</button>
            </div>
          </div>
  ...
  <section class="p-5 text-center">
    <h1 class="mb-5">Nos <b class="text-danger">produits</b></h1>
    <div class="row">

      <div class="col-sm-3">
        <div class="card" id="card">
          <img src="assets/img/produits/arduino.jpg" alt="arduino" style="height:196px" class="card-img-top">
          <div class="card-body">
            <h5 class="card-title">Arduino</h5>
            <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
            <a href="#" class="btn btn-primary">Dans le panier</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="card" id="card">
          <img src="assets/img/produits/raspberry1.jpg" alt="raspberry 15b" style="height:196px" class="card-img-top">
          <div class="card-body">
      ...
      <div class="col-sm-3">
        <div class="card" id="card">
          <img src="assets/img/produits/raspberry2.jpg" alt="raspberry cdc" style="height:196px" class="card-img-top">
          <div class="card-body">
      ...
      <div class="col-sm-3">
        <div class="card" id="card">
          <img src="assets/img/produits/raspberry3.jpg" alt="raspberry org" style="height:196px" class="card-img-top">
          <div class="card-body">
  ...
  <section class="container p-5 text-center mx-auto">
    <h1 class="mb-5">Nos <b class="text-danger">services</b></h1>
    ...
    <div class="row my-5">
      ...
      <div class="card col-md-8 " id="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid, laborum veniam
            minus nobis accusamus dignissimos rem nam odit eos. Minima consequuntur, eaque voluptatem modi perspiciatis
      ...
      <div class="col-md-4">
        <div class="card" id="card">
          <img src="assets/img/services/sav.jpg" alt="garantie" style="height:260px; width:100%" class="img-thumbnail">
        </div>
      </div>
    </div>
    ...
    <div class="row my-5">
      ...
      <div class="col-md-4">
        <div class="card" id="card" ml-0>
          <img src="assets/img/services/garantie.png" alt="garantie" style="height:260px; width:100%"
            class="img-thumbnail">
        </div>
      </div>
    ...
    <div class="row my-5">
      ...
      <div class="col-md-4">
        <img src="assets/img/services/online-training.jpeg" alt="garantie" class="img-thumbnail"
          style="height:260px; width:100%" id="card">
      </div>
    </div>
    ...
    <div class="row my-5">
      ...
      <div class="col-md-4">
        <img src="assets/img/services/board.jpg" alt="Montage en entreprise" class="img-thumbnail"
          style="height:260px;width:100%" id="card">
      </div>
...
//            $select = $_POST["formGender"];
//            echo "</br>";
//            echo "Votre nom:</br>", $name;
//            echo "</br>";
//            echo "Votre prenom:</br>", $firstname;
//            echo "</br>";
//            echo "Votre genre:</br>", $select;
//            echo "</div>";
//            alert $name;
//        }
...
//            }
      ...
      <div class="container">
        <form id="contact-form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" role="form">
          <div class="row">
            <div class="col-xl-8 col-md-12  mx-auto my-3 border rounded shadow-lg bg-dark text-white">
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                  <div class="form-group mt-3">
                    ...
                    <input type="text" name="prenom" placeholder="Saisissez votre prénom" class="form-control" value="<?php echo $prenom; ?>">
                ...
                <div class="col-md-6 col-xs-12 ">
                  <div class="form-group mt-3">
                    ...
                    <input type="text" name="nom" placeholder="Saisissez votre nom" class="form-control" value="<?php echo $nom; ?>">
              ...
              <!--submited-->
                <input type="submit" value="Envoyer" class="btn text-white my-3 btn-lg btn-danger"><i class="fa fa-envelope"></i>
<!--              <a href="#" class="btn text-white my-3 btn-lg btn-danger" type="submit"><i class="fa fa-envelope"></i>-->
<!--                Envoyer</a>-->
            ...
            <!-- Footer -->
            <footer class="container-fluid page-footer font-small text-white bg-dark pt-4 ">
